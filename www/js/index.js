...
function onDeviceReady() {
	...
	function onCordovaCallAnswer(data) {
		console.log("onCordovaCallAnswer");
		// Group call Android Box - Cordova
		if (groupCallData) {
			console.log("startLocalMeeting");
			startLocalMeeting(groupCallData.uri);
			return;
		}
		// Direct call Cordova - Cordova
		closeLocalMeeting();
		console.log("data.callName="+data.callName);
		voIPServer.answer({
			ip: data.callName,
		});
	}
